...
Then I can see "Open tour" Button on Balances Page
And I can see Text as "Deposit, Withdrawal, and Transfer differences" heading
And I can see Text as "We'll guide you through these new processes on a quick tour." paragraph