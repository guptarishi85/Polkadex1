Feature: BalancePage_Pop-up_Trasfer_UI verification

As a user 
I want to test
Pop-up_Trasfer_UI on Balances page
...
Scenario: User able to verify the Transfer pop-up UI on Balances Screen
