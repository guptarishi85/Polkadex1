Feature: BalancePage_Pop-up_Deposit_UI verification
...
Scenario: Verify the Pop-up_Deposit_UI on Balances Screen
...
And I can see Next Button on What is Deposit? popup
And I can see checkbox with text as Don't show again on What is Deposit? popup