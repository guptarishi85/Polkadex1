Feature: BalancePage_Pop-up_Withdrawal_UI verification

As a user 
I want to test
Pop-up_Withdrawal_UI on Balances page
...
Then I can see Next Button on What is Withdrawal? popup
Then I can see Back Button on What is Withdrawal? popup
Then I can see checkbox with text as Don't show again on What is Withdrawal? popup