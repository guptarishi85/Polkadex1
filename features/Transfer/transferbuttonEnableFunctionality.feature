Feature: Balances Page
 ...
 As a user 
 I want to test
 Polkadex Transfer Page

Scenario: Verify Max button functionality on transfer page
...
And I can select PDEX token from right drawer
And I click MAX button on transfer page
