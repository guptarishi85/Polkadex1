Feature: Transfer Page_Trasfer_"From trading account To funding account  verification
...
Scenario: Verify Trasfer From trading account To funding account on transfer page
...
Then I click down arrow button near the token
