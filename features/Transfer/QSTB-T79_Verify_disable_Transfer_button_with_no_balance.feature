Feature: Transfer Page_disable "Transfer" button, if there is no balance verification
...
Scenario: Verify disable "Transfer" button, if there is no balance on transfer page
...
And I enter amount as "2" in amount field
Then I can see Transfer button is Disable to do Transaction
