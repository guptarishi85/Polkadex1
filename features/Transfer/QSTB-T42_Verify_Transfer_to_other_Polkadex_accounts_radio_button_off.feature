Feature: Transfer Page_Transfer_Transfer to other Polkadex accounts radio button_off verification
...
Scenario: Verify Transfer_Transfer to other Polkadex accounts radio button_off
