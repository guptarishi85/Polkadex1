Feature: BalancePage_Pop-up_Withdrawal_checkbox verification

As a user 
I want to test
Pop-up_Withdrawal_checkbox on Balances page
...
And I am able to select Dont show again checkbox on What is WithDrawal? popup
