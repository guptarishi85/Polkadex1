Feature: Exchange Page_user_is_able_to_view_selected_trading_pair_on_button_and_Buy_order_form
 
 As a user 
 I want to test
 Polkadex Exchange Page

Scenario:Verify the user_is_able_to_view_selected_trading_pair_on_button_and_Buy_order_form
