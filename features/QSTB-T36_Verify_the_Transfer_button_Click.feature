Feature: Balances Page Transfer Button verification

 As a user 
 I want to test
 Polkadex Balances Page Transfer_button_Click
...
Scenario: Verify Transfer_button_Click functionalities
...
Then balance page for Transfer button is navigated to "https://orderbook.polkadex.trade/transfer?token=USDT" page
