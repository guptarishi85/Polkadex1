Feature: Balances Page_ Balance_Tocken list_Trading_account

 As a user 
 I want to test
 Balance_Tocken list_list_Trading_account
...
Scenario: Verify Balance_Tocken list_Trading_account 
...
Then I can get the list of tokens under Trading Account Header
