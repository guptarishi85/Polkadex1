Feature: BalancePage_Pop-up_Transfer_done Button verification

As a user 
I want to test
Pop-up_Transfer_done Button on Balances page
...
Scenario: User able to verify the Pop-up_Transfer_done Button on Balances Screen
...
When I click on Done button on What is transfer? popup  
Then Transfer popup window is closed