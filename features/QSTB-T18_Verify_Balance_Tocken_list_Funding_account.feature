Feature: Balances Page_Balance_Tocken list_Funding_account

 As a user 
 I want to test
 Balance_Tocken list_Funding_account
...
Scenario: Verify Balance_Tocken list_Funding_account 
...
Then I can get the list of tokens under Funding Account Header
