Feature: BalancePage_Pop-up_Deposit_Next button verification
...
Scenario: Verify the Pop-up_Deposit_Next button on Balances Screen
...
And I can see Next Button on What is Withdrawal? popup
And I can see Back Button on What is Withdrawal? popup
And I can see checkbox with text as Don't show again on What is Withdrawal? popup