...
Then I click on toggle button
Then I click on ASTR 
Then I click on Hide Zero balances
Then I Unclick on Hide Zero balanaces
Then I hover on SeachBox
Then I enter in SearchBox "DOT"
